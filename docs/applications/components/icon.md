...
`archive`, `audio`, `bell`, `calendar`, `check`, `chevron-down`, `chevron-up`, `chevron-left`, `chevron-right`, `clipboard`, `close`, `code`, `copy`, `crown`, `download`, `drag`, `edit`, `external-link`, `eye`, `eye-off`, `file`, `folder`, `globe`, `hamburger`, `sandwich`, `image`, `info`, `library`, `link`, `logout`, `move`, `pin`, `play`, `plus`, `refresh`, `reply`, `search`, `settings`, `spreadsheet`, `square-stop`, `star`, `sticky-note`, `trash`, `upload`, `user`, `users`, `video`, `warning`, `word-wrap`, `list-view`, `grid-view`, `grid-view-small`
