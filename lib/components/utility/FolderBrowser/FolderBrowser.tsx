  ...
  const loadDirectory = async (path: string) => {
    ...
    try {
      const response = await fetch(
        `/api/system/apps/fs?path=${encodeURIComponent(path)}`,
      );
      const data = await response.json();
          ...
          {loading ? (
            ...
            <div className={styles.list}>
              {drives.map((drive) => (
                <div
                  key={drive}
                  className={`${styles.item} ${styles.driveItem}`}
              ...
              {directories.map((dir) => (
                <div key={dir.path} className={styles.item}>
                  ...
                  >
                    ...
                    >
                      <path
                        d="M3 6C3 4.89543 3.89543 4 5 4H7L9 6H15C16.1046 6 17 6.89543 17 8V14C17 15.1046 16.1046 16 15 16H5C3.89543 16 3 15.1046 3 14V6Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                    </svg>
